...
{
    public abstract class ImpulsoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ImpulsoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ImpulsoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ImpulsoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ImpulsoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ImpulsoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ImpulsoDbContext, Task<T>> func)
        {
            T result;
